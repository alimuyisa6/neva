...
export default function QuizDashboard({ user }) {
  ...
  const xpPercent = data.next_level_xp
    ? (data.xp / data.next_level_xp) * 100
    : 0;
  ...
  return (
    <div className="learner-dashboard">
      ...
      <div className="dashboard-card">
        ...
        <div>
          <span>Badges</span>
          <strong>{data.badges_count}</strong>
        </div>
      </div>
      ...
      <div className="dashboard-card">
        ...
        <div>
          <span>Next Goal</span>
          <strong>
            {data.next_goal?.topic} Block {data.next_goal?.block}
          </strong>
        </div>
      </div>
    </div>
